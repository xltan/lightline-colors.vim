...
let s:p.normal.left = [ [ s:nord5, s:nord2 ], [ s:nord5, s:nord1 ] ]
...
let s:p.inactive.left =  [ [ s:nord10, s:nord2 ], [ s:nord5, s:nord1 ] ]
...
let s:p.tabline.left = [ [ s:nord10, s:nord1 ] ]
let s:p.tabline.middle = [ [ s:nord10, s:nord1 ] ]
let s:p.tabline.right = [ [ s:nord10, s:nord1 ] ]
let s:p.tabline.tabsel = [ [ s:nord5, s:nord2 ] ]

let g:lightline#colorscheme#nord2#palette = lightline#colorscheme#flatten(s:p)
